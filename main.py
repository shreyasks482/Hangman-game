...
# word_list = []
word_list = ['aardvark', 'baboon', 'camel', 'roasted', "rooster", "loading", 'dangerous', 'abruptly', 'absurd', 'abyss',
             ...
             'thumbscrew', 'topaz', 'transcript', 'transgress', 'transplant', 'twelfth', 'twelfths', 'unknown',
...
while not end_of_game:
    ...
    if guess not in chosen_word:
        ...
        if lives == 0:
            ...
            print("GAME OVER")
            wor = ""
            for q in chosen_word:
                wor += q
            print(f"The word was {wor}")
            end_of_game = True
        else:
